  ...
  return (
    <aside
      className={cn(
        ...
        'bg-gradient-to-b from-hoopoe-navy via-[#1E2230] to-[#171B24] text-white',
    ...
    >
      ...
      <div className={cn(
        ...
        <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-hoopoe-orange to-hoopoe-brown flex items-center justify-center flex-shrink-0 shadow-lg shadow-hoopoe-orange/20">
          <Image src="/logos/hoopoe-digital-logo.jpeg" alt="Hoopoe" width={24} height={24} className="rounded-lg" />
        </div>
        {!collapsed && (
          <div className="animate-fade-in">
            <h1 className="text-[15px] font-black tracking-wide">Hoopoe Digital</h1>
            <p className="text-[10px] text-white/40 font-medium tracking-wider uppercase">HR Platform</p>
          </div>
        )}
      </div>
      ...
      {!collapsed && (
        <div className="mx-4 mt-5 mb-1 animate-fade-in">
          <div className="flex items-center gap-2.5 px-3.5 py-3 rounded-2xl bg-gradient-to-r from-hoopoe-orange/[0.12] to-transparent border border-hoopoe-orange/[0.15]">
            ...
            <div>
              <span className="text-[11px] text-hoopoe-lt-orange font-bold block leading-tight">AI Active</span>
              <span className="text-[9px] text-white/30 font-medium">Auto CV screening</span>
            </div>
            <div className="ml-auto w-2 h-2 rounded-full bg-hoopoe-success animate-pulse-orange" />
          </div>
        </div>
      )}
      ...
      <nav className="flex-1 px-3 mt-5 space-y-1">
        <p className={cn(
          'text-[9px] text-white/25 font-bold tracking-[0.2em] uppercase px-3 mb-2',
          collapsed && 'hidden'
        )}>
          Main Menu
        </p>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? 'bg-gradient-to-r from-hoopoe-orange to-hoopoe-brown text-white shadow-lg shadow-hoopoe-orange/20'
        ...
        {!collapsed && (
          <div className="flex items-center gap-3 px-3 py-2 mb-2 rounded-xl bg-white/[0.03]">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[11px] font-bold text-white/80 truncate">HR Manager</p>
